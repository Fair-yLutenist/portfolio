...
const VariableProximity = forwardRef((props, ref) => {
  ...
  useAnimationFrame(() => {
    ...
    letterRefs.current.forEach((letterRef, index) => {
      ...
      interpolatedSettingsRef.current[index] =
        newSettings;
  ...
  /*
   * BLUR TEXT + VARIABLE PROXIMITY
   * Ambas cosas ocurren en LAS MISMAS letras.
   */
